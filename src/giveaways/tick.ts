...
export async function giveawayTick(api: EchoedClient, botUserId: string | null): Promise<void> {
  ...
  await Promise.allSettled(
    due.map((g) =>
      pickAndAnnounce(api, g, { botUserId: botUserId ?? undefined }).catch((err: unknown) => {
